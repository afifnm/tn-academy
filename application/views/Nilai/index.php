<div class="p-4">
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        <div class="intro-y box p-5 w-full overflow-auto lg:w-1/2 bg-white rounded-lg shadow-sm">
            ...
            <div class="mb-6">
                ...
                <form method="GET" class="max-w-xs">
                    ...
                    <button type="submit" class="btn btn-primary w-25 rounded-lg">
                        Tampilkan Mapel
                    </button>
                </form>
            </div>
            ...
            <?php if (isset($id_kelas) && isset($id_ta) && isset($id_mapel)): ?>
                <?php if(!empty($siswa) && !empty($mapel_terpilih)): ?>
                    <form action="<?= base_url('nilai/save') ?>" method="POST">
                        ...
                        <a href="<?= base_url('nilai/daftar/'.$id_kelas.'/'.$id_ta.'/'.$id_mapel) ?>" class="btn btn-info mt-4">
                            Lihat Daftar Nilai
                        </a>
                    </form>
                <?php else: ?>
